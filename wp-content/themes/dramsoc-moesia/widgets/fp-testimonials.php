...
// constructor
	...
	function widget($args, $instance) {
		...
		$title = ( ! empty( $instance['title'] ) ) ? $instance['title'] : __( 'Current and Upcoming Shows', 'moesia' );
			...
			<div class="testimonials clearfix">
				...
				<?php while ( $r->have_posts() ) : $r->the_post(); ?>
					...
					<div class="testimonial col-md-6 col-sm-6 fadeInUp">
						...
						<?php endif; ?>
						<h4 class="client-name col-md-8"><a href="http://dramsoc.org/?tag=<?php echo $function; ?>"><?php the_title(); ?></a></h4>
